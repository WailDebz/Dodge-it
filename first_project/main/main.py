...
pygame.mixer.init()
mixer.music.load("audio/Morning Stroll - Steven O'Brien (Must Credit, CC-BY, www.steven-obrien.net).mp3")
...
# font and score 
i=0
font = pygame.font.Font('fonts/Acme-Regular.ttf', 40)
...
# Importing images
main_surface = pygame.image.load('images/bg.png')
color = (255, 255, 255)
s = 3
